			...
			<div className="container px-5 pt-32 mx-auto lg:px-4 lg:py-4">
				<div className="flex flex-col w-full mb-2 text-center">
					...
					<div className="flex flex-col w-full mb-2 text-center items-center py-4">
						<iframe src="https://discord.com/widget?id=783315747283795969&theme=dark" width="350" height="300" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts" />
					</div>
				</div>
			</div>
