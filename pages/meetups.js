			...
			<section class="text-gray-600 body-font hidden">
				<div class="container px-5 mx-auto">
					<div class="text-center mb-20">
						<h2 class="sm:text-5xl font-medium title-font text-white mb-4">Our Team</h2>
						<p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">Here is our company</p>
							...
							<div class="flex flex-wrap -m-4">
								<div class="p-4 lg:w-1/4 md:w-1/2">
									<div class="h-full flex flex-col items-center text-center">
										...
										></img>
										<div class="w-full">
											<h2 class="title-font font-medium text-lg text-white">Chris</h2>
											<h3 class="text-gray-500 mb-3">Web Developer</h3>
											<p class="mb-4">Chris is part of our front-end team providing amazing websites.</p>
